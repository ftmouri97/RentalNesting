                                    ...
                                    <div class="col-xl-12">
                                        <div class="form_wrap d-flex">
                                            ...
                                            <div class="single-field max_width ">
                                                    ...
                                                    <select class="wide" >
                                                        @php $i=1; @endphp
                                                        @foreach ($zones as $apartment)
                                                        <option @if($i==1) data-display="{{ $apartment->zone }}" @endif>{{ $apartment->district }}</option>
                                                        @php $i++; @endphp
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="single-field min_width ">
                                                    ...
                                                    <select class="wide" >
                                                        ...
                                                        <option @if($i==1) data-display="{{ $apartment->total_bed }}" @endif>{{ $apartment->total_bed }}</option>
                                                        @php $i++; @endphp
                                                        @endforeach
                                                    </select>
                                                </div>
                                            <div class="single-field min_width ">
                                                ...
                                                <select class="wide" >
                                                    ...
                                                    <option @if($i==1) data-display="{{ $apartment->total_bath }}" @endif>{{ $apartment->total_bath }}</option>
                                                    @php $i++; @endphp
                                                    @endforeach
                                                </select>
                                            </div>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_property">
                        ...
                        <div class="property_content">
                            <div class="main_pro">
                                    <h3><a href="{{url('apartment-details/'.$apartment->id)}}">Comfortable Apartment in {{$apartment->zone}}</a></h3>
                                    <div class="mark_pro">
